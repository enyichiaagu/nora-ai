...
const Call: React.FC<CallProps> = ({ data, onCallEnd }) => {
  ...
  const { transcript, isTranscribing, startTranscription, stopTranscription, transcriptions } = useTranscript()
  ...
  return (
    ...
    >
      ...
      <Transcriptions transcript={transcript} isTranscribing={isTranscribing} transcriptions={transcriptions}/>
