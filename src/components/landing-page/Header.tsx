...
function Header() {
	return (
		<header className='absolute flex items-center justify-between w-full max-w-6xl .top-[6%] top-[8vh]  .md:top-[8%] left-1/2 -translate-x-1/2 px-4 md:px-6 lg:px-0 z-20'>
			...
			<div>
				<button className='bg-white text-app-primary rounded-lg px-4 py-2 md:px-6 md:py-2 shadow-lg flex items-center justify-center gap-2 text-sm md:text-base font-medium transition-all hover:shadow-xl'>
